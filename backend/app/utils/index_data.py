...
class IndexData:
    ...
    def generate_table_descriptions(self,table_name, column_names, data):
    ...
    def generate_column_synonyms(self,table_name, column_names, data):
    ...
    def generate_column_descriptions(self,table_name, column_names, data):
